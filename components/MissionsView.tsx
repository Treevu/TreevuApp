                        ...
                        <div className="mt-4">
                         ...
                         <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
                            <div className="bg-background p-2 rounded-lg">
                                <p className="font-bold text-primary mb-1">Valor para Ti:</p>
                                <p className="text-on-surface-secondary">{activeMission.valueForEmployee}</p>
                            </div>
                            <div className="bg-background p-2 rounded-lg">
                                <p className="font-bold text-primary mb-1">Valor para el Equipo:</p>
                                <p className="text-on-surface-secondary">{activeMission.valueForCompany}</p>
                            </div>
                        </div>
                    ...
                    <div key={mission.id} className="bg-surface rounded-2xl p-4">
                        <div className="flex items-start gap-4">
                         ...
                         <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
                            <div className="bg-background p-2 rounded-lg">
                                <p className="font-bold text-primary mb-1">Valor para Ti:</p>
                                <p className="text-on-surface-secondary">{mission.valueForEmployee}</p>
                            </div>
                            <div className="bg-background p-2 rounded-lg">
                                <p className="font-bold text-primary mb-1">Valor para el Equipo:</p>
                                <p className="text-on-surface-secondary">{mission.valueForCompany}</p>
                            </div>
                        </div>

...
const ConfirmDeleteModal: React.FC<ConfirmDeleteModalProps> = ({ onClose, onConfirm }) => {
    return (
        <ModalWrapper title="Eliminar Hallazgo" onClose={onClose}>
            <div className="text-center">
                ...
                <div className="mt-4">
                    <p className="text-sm text-on-surface-secondary">
                        ¿Estás seguro de que quieres eliminar este hallazgo? Esta acción no se puede deshacer.
                    </p>
                </div>
                <div className="mt-6 flex justify-end space-x-3">
                    ...
                    <button
                        type="button"
                        onClick={onConfirm}
                        className="px-6 py-2.5 text-sm font-bold text-white bg-danger rounded-xl hover:bg-red-600 flex items-center shadow-lg shadow-danger/20 transition-all"
                    >
